...
ytkit/1.4.1 darwin-x64 node-v16.4.0
$ ytkit --help [COMMAND]
USAGE
  $ ytkit COMMAND
...
...
_See code: [src/commands/download.ts](https://github.com/maggiben/ytkit/blob/v1.4.1/src/commands/download.ts)_
...
_See code: [src/commands/info.ts](https://github.com/maggiben/ytkit/blob/v1.4.1/src/commands/info.ts)_
